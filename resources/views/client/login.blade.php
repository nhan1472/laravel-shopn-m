...
@section('content')
    <div ng-controller="lgcontroller" class="container">
        <div class="row d-none d-md-block" style="margin: 100px;">
            ...
            <div ng-if="!anhien" class="col-12 border d-md-block" style="padding: 50px;box-shadow: 0px 1px 5px rgb(0 0 0 / 10%);border-radius:10%; ">
        ...
        <div class="row d-block d-md-none">
            ...
            <div class="col-12 border " ng-if="anhien">
                <h3 class="text-center my-5">Đăng Nhập</h3>
                <form method="POST" action="{{ route('login') }}">
                    @csrf
            ...
            <div ng-if="!anhien" class="col-12 border ">
                <h3 class="text-center mb-5">Lấy lại mật khẩu</h3>
                <form method="POST" action="{{ route('password.email') }}">
                    @csrf
                    <div class="row mb-3">
                        <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Email Đăng nhập') }}</label>
